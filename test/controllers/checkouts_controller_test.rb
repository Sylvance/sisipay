...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference("Checkout.count") do
      post checkouts_url, params: { checkout: { amount: @checkout.amount, identity: @checkout.identity, recipient_token: @checkout.recipient_token, redirect_uri: @checkout.redirect_uri, sender_token: @checkout.sender_token } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { amount: @checkout.amount, identity: @checkout.identity, recipient_token: @checkout.recipient_token, redirect_uri: @checkout.redirect_uri, sender_token: @checkout.sender_token } }
