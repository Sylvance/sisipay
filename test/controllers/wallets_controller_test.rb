...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { amount: @wallet.amount, checkout_url: @wallet.checkout_url, recipient_token: @wallet.recipient_token, sender_token: @wallet.sender_token } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { amount: @wallet.amount, checkout_url: @wallet.checkout_url, recipient_token: @wallet.recipient_token, sender_token: @wallet.sender_token } }
